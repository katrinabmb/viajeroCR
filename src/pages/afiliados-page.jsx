...
export function AfiliadosPage() {
  ...
  async function handleSaveTitle() {
    ...
    try {
      ...
      await load()
      showBanner('success', 'Titulo actualizado correctamente.')
  ...
  async function handleSaveLogo() {
    ...
    try {
      ...
      await load()
      showBanner('success', isEditing ? 'Logo actualizado correctamente.' : 'Logo creado correctamente.')
  ...
  async function handleDelete(item) {
    ...
    try {
      ...
      showBanner('success', 'Logo eliminado correctamente.')
    } catch (err) {
